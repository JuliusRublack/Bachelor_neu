...
```{r infboptimisch, fig.show='hold', message = FALSE, warning=FALSE, results=FALSE, fig.cap="", out.width= "49%", fig.align='center', fig.scap="Optimierung der Reaktionstemperatur und der Primerassymetrie."}
...
```{r infaopti,  fig.show='hold', message = FALSE, warning=FALSE, results=FALSE, fig.cap="", out.width= "49%", fig.align='center', fig.scap="Optimierung der Reaktionstemperatur und der Primerassymetrie."}
